...
Apply this skeleton when the confirmed archetype is Process & Operations. Load alongside:
...
A role fits this archetype when the primary deliverable is operational efficiency, standardization, quality, or process excellence. Characteristic contexts include SOP design and maintenance, process harmonization across functions or sites, steady-state operational management, inspection readiness, and optimization of established ways of working. The archetype emphasizes durable process improvement rather than organizational transformation or new capability construction.
...
- Inventory tag priorities (High, Medium, Use-if-space, Avoid)
