...
Build and maintain `knowledge/Positioning.md` — the personal brand and positioning document that articulates who the user is, how they create value, and how they communicate that value to recruiters, hiring managers, and professional networks. This document is a source for `cv_targeted`, interview preparation, and direct professional outreach.
...
**Standard Phase Closing — Action Phases (1a, 2a, 3a, 4a, 5a, 6a)**
